...
class SANLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=512, dropout=0.1):
        ...
        self.self_attn = GlobalContextAwareAttention(d_model, nhead, dropout=dropout)
...
class CMANLayer(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=512, dropout=0.1):
        ...
        self.cm_attn = GlobalContextAwareAttention(d_model, nhead, dropout=dropout)
    ...
    def forward(self, src_q, src_v, src_mask=None, src_key_padding_mask=None):
        ...
        src1 = self.cm_attn(src_q, src_v, src_v, src_qc, src_vc, mask=src_mask)[0]
